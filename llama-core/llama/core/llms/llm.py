...
from llama.core.bridge.pydantic import BaseModel, Field, validator
from llama.core.callbacks import CBEventType, EventPayload
...
from llama.core.prompts import BasePromptTemplate, PromptTemplate
from llama.core.types import (
    BaseOutputParser,
    PydanticProgramMode,
    TokenAsyncGen,
    TokenGen,
...
class LLM(BaseLLM):
    ...
    def structured_predict(
        ...
        **prompt_args: Any,
        ...
        from llama.core.program.utils import get_program_for_llm
