...
from llama.core.bridge.pydantic import Field

if TYPE_CHECKING:
    from llama.core.bridge.langchain import BasePromptTemplate as LangchainTemplate
    from llama.core.bridge.langchain import (
        ConditionalPromptSelector as LangchainSelector,
    )
from llama.core.bridge.pydantic import BaseModel
from llama.core.llms.types import ChatMessage
from llama.core.query_pipeline.query_component import (
    ChainableMixin,
    InputKeys,
    OutputKeys,
    QueryComponent,
...
from llama.core.llms.base import BaseLLM
from llama.core.llms.generic_utils import (
    messages_to_prompt as default_messages_to_prompt,
)
from llama.core.llms.generic_utils import (
    prompt_to_messages,
)
from llama.core.prompts.prompt_type import PromptType
from llama.core.prompts.utils import get_template_vars
from llama.core.types import BaseOutputParser
...
class LangchainPromptTemplate(BasePromptTemplate):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "Must install `llama.core.langchain]` to use LangchainPromptTemplate."
            )
        if selector is None:
            if template is None:
    ...
    def format(self, llm: Optional[BaseLLM] = None, **kwargs: Any) -> str:
        """Format the prompt into a string."""
        from llama.core.llms.langchain import LangChainLLM
    ...
    def format_messages(
        ...
        """Format the prompt into a list of chat messages."""
        from llama.core.llms.langchain import LangChainLLM
        from llama.core.llms.langchain_utils import from_lc_messages
