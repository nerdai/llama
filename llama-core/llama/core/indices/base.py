...
from llama.core.chat_engine.types import BaseChatEngine, ChatMode
from llama.core.core.base_query_engine import BaseQueryEngine
from llama.core.core.base_retriever import BaseRetriever
from llama.core.data_structs.data_structs import IndexStruct
from llama.core.ingestion import run_transformations
from llama.core.llms.openai import OpenAI
from llama.core.llms.openai_utils import is_function_calling_model
from llama.core.schema import BaseNode, Document
from llama.core.service_context import ServiceContext
from llama.core.storage.docstore.types import BaseDocumentStore, RefDocInfo
from llama.core.storage.storage_context import StorageContext
...
class BaseIndex(Generic[IS], ABC):
    ...
    def as_query_engine(self, **kwargs: Any) -> BaseQueryEngine:
        # NOTE: lazy import
        from llama.core.query_engine.retriever_query_engine import RetrieverQueryEngine
    ...
    def as_chat_engine(
        ...
        if chat_mode == ChatMode.CONDENSE_QUESTION:
            # NOTE: lazy import
            from llama.core.chat_engine import CondenseQuestionChatEngine
            ...
            from llama.core.chat_engine import ContextChatEngine
            ...
            from llama.core.chat_engine import CondensePlusContextChatEngine
            ...
            # NOTE: lazy import
            from llama.core.agent import OpenAIAgent, ReActAgent
            from llama.core.tools.query_engine import QueryEngineTool
            ...
            from llama.core.chat_engine import SimpleChatEngine
