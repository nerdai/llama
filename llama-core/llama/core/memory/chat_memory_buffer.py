...
from llama.core.bridge.pydantic import Field, root_validator
from llama.core.llms.types import ChatMessage, MessageRole
from llama.core.llms.llm import LLM
from llama.core.llms.types import ChatMessage, MessageRole
from llama.core.memory.types import DEFAULT_CHAT_STORE_KEY, BaseMemory
from llama.core.storage.chat_store import BaseChatStore, SimpleChatStore
from llama.core.utils import get_tokenizer
...
class ChatMemoryBuffer(BaseMemory):
    ...
    def from_dict(cls, data: Dict[str, Any], **kwargs: Any) -> "ChatMemoryBuffer":
        from llama.core.storage.chat_store.loading import load_chat_store
