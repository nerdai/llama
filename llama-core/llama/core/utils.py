...
def set_global_tokenizer(tokenizer: Union[Tokenizer, Callable[[str], list]]) -> None:
    ...
    if isinstance(tokenizer, Tokenizer):
        llama.core.global_tokenizer = tokenizer.encode
    else:
        llama.core.global_tokenizer = tokenizer


def get_tokenizer() -> Callable[[str], List]:
    import llama.core

    if llama.core.global_tokenizer is None:
        tiktoken_import_err = (
    ...
    assert llama.core.global_tokenizer is not None
    return llama.core.global_tokenizer
